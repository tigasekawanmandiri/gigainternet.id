...
<head>
	...
	<title>GigaInternet - Login</title>
</head>
				...
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					<div class="col mx-auto">
						<div class="mb-4 text-center">
							<img src="{{ asset('template/images/giga_merah.png') }}" width="180" alt="" />
						</div>
						<div class="card">
							<div class="card-body">
									...
									<div class="form-body">
										<form class="row g-3" method="post" action="{{ route('login.post')}}">
											...
											<div class="col-12">
												...
												<input type="email" name="email" value="gigaadmin@gmail.com" class="form-control" id="inputEmailAddress" placeholder="Email Address">
											</div>
											<div class="col-12">
