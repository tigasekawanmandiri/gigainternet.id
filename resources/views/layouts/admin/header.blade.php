        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('template/images/giga_tegak_merah.png') }}" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">Admin Giga</p>
                        <p class="designattion mb-0">Marketing</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout.post') }}">
                            @csrf
                        <a class="dropdown-item" href="{{ route('logout.post')}}" onclick="event.preventDefault(); this.closest('form').submit();">
